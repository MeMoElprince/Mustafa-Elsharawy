const AnimationOffice = () => {
    return ( 
        <svg className="h-75 w-fit mxs:h-72" width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="study">
...
export default AnimationOffice;