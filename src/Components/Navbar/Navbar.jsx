...
const Navbar = () => {
    ...
    return ( 
        <div className="bg-pallete-100 w-full flex flex-col p-2 h-fit   lg:h-full lg:col-span-1 lg:gap-6  lg:items-center">
            ...
            <div className=" mxs:justify-around h-fit w-full flex justify-between lg:justify-center lg:gap-3 items-center flex-wrap lg:py-6 lg:flex-col">
                ...
                <h1 className='mxs:hidden text-pallete-400 text-4xl font-bold lg:text-3xl  text-center'> Full Stack Developer  </h1>
            ...
            navbar && 
            <motion.div className="lg:hidden items max-w-full w-fit h-screen flex-col flex items-start fixed top-0 z-50 overflow-y-auto -right-0 bg-pallete-200 pl-8 pr-16 py-10"
                initial={{x: 300}}
                animate={{x: 0}}
                exit={{x: 300}}
